    ...
    .map(function(jadedocBlock) {
      ...
      if(meta.arguments){
        meta.arguments = meta.arguments.map(function(arg){
          return jadedocArguments.parse(arg, true);
        });
      }
...
function parseJadedocComment(comment){
  ...
  comment = jadedocArguments.escapeArgumentsYAML(comment, 'arguments');
  comment = jadedocArguments.escapeArgumentsYAML(comment, 'attributes');
