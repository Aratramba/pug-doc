...
function getType(str){
  ...
  }else if(str.indexOf(constants.TYPE_EXTENDS) > -1){
    type = constants.TYPE_EXTENDS;
  }else if(str.search(constants.TYPE_BLOCK_REGEX) > -1){
    type = constants.TYPE_BLOCK;
  }else if(str.search(constants.TYPE_BLOCK_APPEND_REGEX) > -1){
    type = constants.TYPE_BLOCK_APPEND;
  }else if(str.search(constants.TYPE_BLOCK_PREPEND_REGEX) > -1){
    type = constants.TYPE_BLOCK_PREPEND;
  }else{
